...
// From game dev guide
// https://youtu.be/9fa4uFm1eCE?t=367

[Serializable, VolumeComponentMenuForRenderPipeline("Game Dev Guide/Ben Day Bloom",  typeof(UniversalRenderPipeline))]
public class BenDayBloomEffectComponent : VolumeComponent, IPostProcessComponent
{
	...
	{
		// Implement logic to determine if the effect is active
		return true; // Replace with actual condition
	}

	public bool IsTileCompatible()
	{
		// Implement logic to determine if the effect is tile compatible
